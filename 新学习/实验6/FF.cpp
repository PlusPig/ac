...
int V;
bool visited[maxs];
int capacity[maxs][maxs], res[maxs][maxs];
int parent[maxs], unplay[maxs], win[maxs];
string teamname[maxs];
vector<int> connected[maxs]; // 表示邻接表
...
int main()
{
    int n;
    string str;
    ifstream ifs("D:\\edge downlode anything\\baseball\\teams24.txt");
    ifs >> n;
